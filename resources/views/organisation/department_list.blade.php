    ...
    <div class="page-body ra_bodyHeader">
        <div class="widget ra_widgetMarginBody">
            <div class="widget-header ra_bodyHeaderTitleIcon">
                ...
                <span class="widget-caption"><strong>Department Management</strong></span>
        ...
        <div id="pagination">
            <div class="widget">
                <div class="widget-header ra_bodyHeaderTitleIcon">
                    ...
                    <span class="widget-caption">Department List Total : 0 Showing 0 to 0</span>
                    <div class="widget-buttons">
                        <div class="btn-group">
                    ...
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tbody class="raTabletbody">
                            <tr>
                                ...
                                <td class="raTableBodyNR">
                                    <a href="#" class="btn btn-danger btn-xs delete" onclick="return confirm('Do you really want to remove this Department?')">
                            ...
                            <tr>
                                <td colspan="11" align="center">
                                    <!-- Pagination or additional content here -->
                                </td>
                            </tr>
                        </tbody>
                    </table>
...
function dopagination(pageNumber) {
    ...
    var locationID = document.getElementById("locationID").value || 0;
    var title = document.getElementById("title").value || 'NULL';
    var limit = document.getElementById("limit").value || 10;
    var url = "#";
    var myRandom = parseInt(Math.random() * 99999999);
    xmlhttp.onreadystatechange = stateChanged;
    xmlhttp.open("GET", url + "/" + encodeURIComponent(pageNumber) + "/" + encodeURIComponent(limit) + "/" + encodeURIComponent(orgID) + "/" + encodeURIComponent(locationID) + "/" + encodeURIComponent(title) + "/" + myRandom, true);
    xmlhttp.send(null);
}
