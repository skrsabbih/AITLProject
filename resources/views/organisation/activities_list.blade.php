    ...
    <div class="page-body ra_bodyHeader">
        <div class="widget ra_widgetMarginBody">
            <div class="widget-header ra_bodyHeaderTitleIcon">
                ...
                <span class="widget-caption"><strong>Activities Management</strong></span>
                <div class="widget-buttons">
                    <div class="form-group ra_form-group">
                        <a href="{{ url('organization/activitiesForm/0') }}" class="btn btn-sm btn-maroon shiny">
            ...
            <div class="widget-body">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td class="ra_SeachTDPaddingRight" align="left">
                            <div class="form-group ra_form-group">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-tag blue"></i></span>
        ...
        <div id="pagination">
            <div class="widget">
                <div class="widget-header ra_bodyHeaderTitleIcon">
                    ...
                    <span class="widget-caption">Activities List Total : 0 Showing 0 to 0</span>
                    <div class="widget-buttons">
                        <div class="btn-group">
                    ...
                    <table class="table table-bordered table-striped table-condensed flip-content">
                        ...
                        <tbody class="raTabletbody">
                            <tr>
                                ...
                                <td class="raTableBodyNR">
                                    <a href="#" class="btn btn-danger btn-xs delete" onclick="return confirm('Do you really want to remove this Title?')">
...
function dopagination(pageNumber) {
    ...
    var categoryID = document.getElementById("categoryID").value || 'NULL';
    var title = document.getElementById("title").value || 'NULL';
    var limit = document.getElementById("limit").value || 10;
    var url = "{{ url('organization/activitiesPagination') }}";
    var myRandom = parseInt(Math.random() * 99999999);

    xmlhttp.onreadystatechange = stateChanged;
    xmlhttp.open("GET", url + "/" + encodeURIComponent(pageNumber) + "/" + encodeURIComponent(limit) + "/" + encodeURIComponent(categoryID) + "/" + encodeURIComponent(title) + "/" + myRandom, true);
    xmlhttp.send(null);
}
